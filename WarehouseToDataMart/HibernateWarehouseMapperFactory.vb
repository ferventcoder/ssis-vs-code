...
Public Class HibernateWarehouseMapperFactory
    ...
    Public Shared ReadOnly Property SessionFactory() As ISessionFactory
        Get
            If (_factory Is Nothing) Then
                ...
                Dim filePath As String = projectDirectory & ConfigurationManager.AppSettings("HibernateMappingFilePath") & "Warehouse"
                Dim config As Cfg.Configuration = New Cfg.Configuration()
                Dim cn As String = ConfigurationManager.ConnectionStrings("Warehouse").ConnectionString()
